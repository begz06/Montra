...
import 'package:montra_app_a1/modules/budget/presentation/view/screens/budget_screen.dart';
import 'package:montra_app_a1/modules/home/presentation/ui/homeScreen.dart';


import 'package:montra_app_a1/modules/navigation/presentation/home.dart';
import 'package:montra_app_a1/modules/transaction/presentation/ui/transaction.dart';
  ...
  Map<String, WidgetBuilder> _routeBuilders(
    ...
    switch (widget.tabItem) {
      ...
      case NavItemEnum.search:
        return {
          TabNavigatorRoutes.root: (context) => TransactionScreen(),
        };

      case NavItemEnum.favourite:
        return {
          TabNavigatorRoutes.root: (context) =>const BudgetScreen(),
        };
