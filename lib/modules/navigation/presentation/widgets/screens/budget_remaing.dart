...
import 'package:montra_app_a1/modules/navigation/presentation/widgets/screens/edit_budget.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              IconButton(
                  onPressed: () {}, icon: SvgPicture.asset(AppIcons.arrow)),
              Text(
                "Detail Budget",
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [
                  SvgPicture.asset(AppIcons.shopping,height: 50,),
                  Text(
                    "Shopping",
                    style: GoogleFonts.roboto(
